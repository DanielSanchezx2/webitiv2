        ...
        for(var id in mail_message){
            ...
            editButton.onclick = function(){
                ...
                **/
                ...
                var shortcodes = {id: object._i18n.get("ID"), date: object._i18n.get("Booking date"), service: object._i18n.get("Service")};
                if(account.type == 'hotel'){
                    
                    shortcodes = {id: object._i18n.get("ID"), bookingDetails: object._i18n.get("Booking details"), checkIn: object._i18n.get("Arrival (Check-in)"), checkOut: object._i18n.get("Departure (Check-out)"), guests: object._i18n.get("Guests"), service: object._i18n.get("Service")};
