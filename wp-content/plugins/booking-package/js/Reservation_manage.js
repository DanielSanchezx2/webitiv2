...
function Booking_manage(schedule_data, booking_package_dictionary, webApp) {
    ...
    this._responseText = "";
    this._lookForUser = schedule_data.lookForUser;
    object._console.log('lookForUser = ' + this._lookForUser);
    ...
    this.createForm = function(mainPanel, courseMainPanel, scheduleMainPanel, formMainPanel, month, day, year, calendarData, courseList, schedule, selectedOptions, accountKey, user, callback){
    	...
    	if (parseInt(object._lookForUser) == 1 && parseInt(object._isExtensionsValid) == 1) {
    	    ...
    	    lookForUserButton.onclick = function() {
    	        ...
    	        object.lookForUser(function(user) {
    	            ...
    	            object.createForm(mainPanel, courseMainPanel, scheduleMainPanel, formMainPanel, month, day, year, calendarData, courseList, schedule, selectedOptions, accountKey, user, callback);
